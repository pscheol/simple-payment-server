...
insert into tb_daily_exchange_rate(currency_code, exchange_rate, current_dtm) values('USD', 1482.52, now());
...
insert into tb_wallet(wallet_id, user_id, currency_code, balnace) values('wallet2','user1234', 'KRW', 10000);
